...
// Brookfield's app shell gets clean line icons WITHOUT bumping tec-ui to 2.x (a
// coordinated breaking palette change). Paths mirror @yasser172/tec-ui (lucide, 24-grid).
import type { CSSProperties } from 'react';

export type BrookfieldIconName = 'building' | 'layers' | 'star' | 'settings' | 'chevron-right';

const PATHS: Record<BrookfieldIconName, string> = {
...
export function Icon({
  ...
  name: BrookfieldIconName; size?: number; color?: string; strokeWidth?: number; style?: CSSProperties;
}) {
  return (
    <svg
